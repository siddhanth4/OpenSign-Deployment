  ...
  return (
    <>
      <div className="op-navbar bg-base-100 shadow touch-none">
        ...
        {/* LOGO SECTION UPDATE */}
        {/* LOGO SECTION UPDATE: Increased your logo size without changing header height */}
        <div className="flex-1 ml-2">
          <div
            onClick={() => navigate("/dashboard/35KBoSgoAK")}
            className="flex flex-row items-center gap-4 cursor-pointer w-auto h-full"
          >
            {/* 1. Legal Data Forensic Logo (Forced larger) */}
            <div className="h-full flex items-center">
              <img
                src={myLogo}
                className="object-contain h-[70px] w-auto max-w-[250px]"
            ...
            {/* 2. OpenSign Logo (Smaller to maintain header balance) */}
            {applogo && (
              <div className="h-full flex items-center">
                <img
